...
|----------------------|-----------------------------------|--------|
| **🏠 Dashboard** | AI SPED Secretary HQ: date, who-am-I-seeing, stats pills, this week / scrollable dues, **Virtual meetings**, **Meeting Timer** (recordable session → summarize → Evals), to-do, team chat dock | Partial — Graph calendar / Outlook auto-sync / true Teams embed later |
