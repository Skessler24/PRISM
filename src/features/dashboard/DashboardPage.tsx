...
Generated by PRISM Dashboard`
  ...
  return (
    ...
    >
      ...
      {todaySlots.length > 0 && (
        <section className="mb-3 rounded-2xl border border-emerald-200 bg-emerald-50 p-3 shadow-card">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <h2 className="font-heading text-sm font-bold">Who am I seeing today?</h2>
            <Link to="/planner" className="text-xs font-semibold text-emerald-800">
              Full planner →
            </Link>
          </div>
          <ul className="mt-2 flex flex-wrap gap-2">
            {todaySlots.map((s) => (
              <li
                key={s.id}
                className="rounded-xl border border-emerald-200 bg-white px-3 py-2 text-xs"
              >
        ...
        <section className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-4 shadow-card">
          ...
          <div className="mt-3 grid gap-2 sm:grid-cols-2">
            {[
              ...
              { to: '/meeting-prep', label: '📋 Meeting Prep' },
